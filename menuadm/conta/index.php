...
<?php
    ...
    if(isset($_POST['encerraB'])){
        ...
        session_destroy();
        pg_close($conecta);
        ECHO '<script type="text/javascript">window.open("http://200.145.153.175/marcotoledo/gremio/menuadm/login","_self")</script>';
    }
    if(isset($_POST['subB'])){
        $ra = $_POST['ra'];
        $senha = $_POST['senha'];
