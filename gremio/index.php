...
<?php
    ...
    if(isset($_POST['envia']))
    {
        ...
        {
        ?>
            <script>alert("Mensagem enviada com sucesso!"); document.getElementById("msgFrm").reset();</script>
        <?php
        }
        else
        {
        ?>
            <script>alert("Erro no envio da mensagem! Tente novamente.");</script>
        <?php
        }
    }
?>
...
<body>
    ...
    <center>
        <div id="frmMsg">
            <h3>Você precisa estar logado para mandar propostas ao grêmio! <br> <a href="../login/" class="link">Clique aqui para logar agora!</a> </h3>
        </div>
    </center>
    <?php
        }
